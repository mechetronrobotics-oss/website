    ...
    <>
      ...
      >
        <div className="container-x w-full flex items-center justify-between">
          ...
          {/* ── Navigation (Center) ── */}
          <nav suppressHydrationWarning ref={navRef} className="hidden lg:flex items-center gap-6 xl:gap-8" aria-label="Main navigation">
            {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={`relative flex items-center gap-1.5 text-[15px] font-medium transition-colors duration-200 pb-1.5 ${
                    ...
                    >
                      ...
                      {isActive && (
                        <span className="absolute bottom-[-14px] left-0 right-0 h-[2.5px] bg-[#0355BC] rounded-t-full" />
                      )}
                    </button>
              ...
              return (
                <Link
                  ...
                  key={link.href}
                  href={link.href}
                  className={`relative text-[15px] font-medium transition-colors duration-200 pb-1.5 ${
                    isActive ? "text-brand-blue" : "text-brand-ink/80 hover:text-brand-blue"
                  }`}
                >
                  {link.label}
          ...
          <div className="hidden lg:flex items-center">
            <Link
              href="/contact"
              className="px-6 py-2.5 rounded-full text-[14px] font-semibold bg-[#25D366] hover:bg-[#1ebe5d] text-white transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
            >
              Book Free Demo
            </Link>
          </div>
      ...
      >
        ...
        <nav className="p-6 overflow-y-auto h-[calc(100%-70px)]">
          ...
          <Link
            href="/contact"
            className="w-full mt-8 py-3 rounded-xl flex items-center justify-center bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold transition-colors"
          >
            Book Free Demo
          </Link>
        </nav>
